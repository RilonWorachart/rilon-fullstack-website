        ...
        <>
            <div className="overflow-hidden">
                <div className="py-3 flex justify-start items-center">
                    <FaBuilding className="mt-[2px] mr-4 min-w-[25px]" />
                ...
                {/* <div className="py-3 flex justify-start items-center">
                    <FaFax className="mt-[2px] mr-4 min-w-[25px]" />
                    <div className="flex flex-wrap">
                ...
                <div className="py-3 flex justify-start items-center">
                    <FaGlobe className="mt-[2px] mr-4 min-w-[25px]" />
                    <div className="flex flex-wrap">
                ...
                <div className="py-3 flex justify-start items-center">
                    <FaClock className="mt-[2px] mr-4 min-w-[25px]" />
                ...
                <div className="py-3 pr-2 flex text-[16px] ">
                    <FaShareAlt className=" mt-1.5 mr-4 min-w-[25px]" />
