        ...
        axios.post(`${process.env.REACT_APP_API}/createsearchword`, formDataToSend, {
            ...
            .then((response) => {
                ...
                if (response.data.status === 'ok') {
                    ...
                    setTimeout(() => {
                        window.location = "/adminsearchword"; // Redirect to the admin item page after success
                    }, 1000);
                } else {
                    Swal.fire({
                        title: 'Fail!',
...
export default AdminSearchwordPage